...
function recepe_block_render_callback($attributes)
{
    ...
    <div class="recepe-card"
        ...
        <h4 style="color:<?php esc_attr_e($attributes['receipenamecolor']);?>">
        <?php esc_attr_e($attributes['title']);?>
        </h4>
        <div class="main swiper-slide" style="padding-left:<?php esc_attr_e($attributes['paddingleft']);?>;
        padding-right:<?php esc_attr_e($attributes['paddingright']);?>;">
...
foreach ($attributes['images'] as $index => $item) {
    ...
    ?>
        ...
        <p style="color:<?php esc_attr_e($attributes['subcontentcolor']);?>">
        Preparation Time: <?php esc_attr_e($attributes['preptime']);?> minutes
        </p>

        <p style="color:<?php esc_attr_e($attributes['subcontentcolor']);?>">
        Cook Tine: <?php esc_attr_e($attributes['cooktime']);?> minutes
        </p>

        <p style="color:<?php esc_attr_e($attributes['subcontentcolor']);?>">
        Additional Time: <?php esc_attr_e($attributes['additional']);?> minutes
        </p>
        <?php
